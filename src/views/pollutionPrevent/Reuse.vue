<template>
  <div class="reuse">
    <div class="reuse-left">
      ...
      <div class="words">
        建设废弃物收集池6个，规格8m×5m×2.5m，共600m3，基本实现示范区内农药废弃包装物的全部回收和安全处置。建设农田废弃物收贮堆沤池9个，规格5m×5m×2m，共450m3，共可一次性收集和处理农业废弃物约4.2吨。购买秸秆打捆机械1套，包括TR90摊草机，404Pro捡拾压捆机，每套配80及120拖拉机各一台。建设秸秆堆场2个，面积5000
        m2，实现了项目区稻草的快速打捆-储存与离田化资源化再利用。
